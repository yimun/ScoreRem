...
class Mcurl
{
    ...
    public $loginUrl = 'http://202.118.65.21:8080/';
    public $crawlUrl;
        
    public function __construct ($params)
    {
        $this->crawlUrl = $this->loginUrl;
        $this->loginUrl .= 'loginAction.do?zjh='.$params['stuid']
                        .'&mm='.$params['pass'];
    ...
    {
        $cookie_file = tempnam('./Temp', 'cookie');// 目录不存在则保存到系统内,当前根目录是在dutserver目录下，与index.php同级
